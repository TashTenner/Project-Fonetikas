...
const spanishHebrew = {
  unitOne: {
    word1: [
      "yo",
      iHeb,
      "Unidad 1, palabra 1 de <num>",
      listenAudio.wordIntro.spanish,
      listenAudio.threeOptionsAudios.spanish,
      "Último sonido: lleva la fuerza de la palabra."
    ],
    word2: [
      "estoy",
      noWordHeb,
      "Unidad 1, palabra 2 de <num>",
      listenAudio.wordIntro.spanish,
      listenAudio.threeOptionsAudios.spanish,
      "Esta palabra / este concepto no existe en hebreo."
    ],
    word3: [
      "aquí",
      hereHeb,
      "Unidad 1, palabra 3 de <num>",
      listenAudio.wordIntro.spanish,
      listenAudio.threeOptionsAudios.spanish,
      "Pronunciación fácil. :)"
    ],
    phrase1: [
      ...
      "Yo estoy aquí. Sintaxis hebrea: Yo aquí.",
      "Unidad 1, frase 1 de <num-phrase>",
      [iHeb, hereHeb],
      [iHeb, hereHeb] // solution
      // [ichBinHierGer]
    ],
    word4: [
      "allí",
      thereHeb,
      "Unidad 1, palabra 4 de <num>",
      listenAudio.wordIntro.spanish,
      listenAudio.threeOptionsAudios.spanish,
      "Primer sonido: [sh] inglés. Úlitmo sonido: [m] clara."
    ],
    phrase2: [
      listenAudio.createPhrase.spanish,
      "Yo estoy allí. Sintaxis hebrea: Yo allí.",
      "Unidad 1, frase 2 de <num-phrase>",
      [iHeb, thereHeb],
      [iHeb, thereHeb] //solution
      // [ichBinDort]
    ],
    word5: [
      "tú(1)",
      youMHeb,
      "Unidad 1, palabra 5 de <num>",
      listenAudio.wordIntro.spanish,
      listenAudio.threeOptionsAudios.spanish,
      "Último sonido: [a] lleva la fuerza de la palabra."
    ],
    word6: [
      "tú(2)",
      youFHeb,
      "Unidad 1, palabra 6 de <num>",
      listenAudio.wordIntro.spanish,
      listenAudio.threeOptionsAudios.spanish,
      "Último sonido: [t] clara y fuerte."
    ],
    word7: [
      "estás",
      noWordHeb,
      "Unidad 1, palabra 7 de <num>",
      listenAudio.wordIntro.spanish,
      listenAudio.threeOptionsAudios.spanish,
      "Esta palabra / este concepto no existe en hebreo."
    ],
    phrase3: [
      listenAudio.createPhrase.spanish,
      "Tú(1) estás aquí. Sintaxis hebrea: Tú(1) allí.",
      "Unidad 1, frase 3 de <num-phrase>",
      [youMHeb, hereHeb],
      [youMHeb, hereHeb] //solution
      // [ichBinDort]
    ]
    // estasSpa: [
    //   "estás",
